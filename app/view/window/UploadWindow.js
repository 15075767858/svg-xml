Ext.define("svgxml.view.window.UploadWindow", {
    extend: "Ext.window.Window",
    alias: "uploadwindow",
    requires: [
        "svgxml.view.window.UploadWindowController",
        "svgxml.view.window.UploadWindowModel",
        "Ext.grid.column.*",
        'Ext.ProgressBarWidget',
        "Ext.grid.*"
    ],
    controller: "window-uploadwindow",
    viewModel: {
        type: "window-uploadwindow"
    },
    layout:"border",
    title: "Upload Files",
    autoShow: true,
